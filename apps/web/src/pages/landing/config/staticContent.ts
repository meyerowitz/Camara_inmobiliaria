...
export const STATIC = {
  ...
  footer: {
    ...
    copyright: '© 2026 Cámara Inmobiliaria del Estado Bolívar. Todos los derechos reservados.',
  },

  // ── Hero (Header) ─────────────────────────────────────────────────────────
  hero: {
    titulo: 'Unidos por el <span class="text-emerald-500 italic">progreso</span> inmobiliario de Bolívar',
    subtitulo:
