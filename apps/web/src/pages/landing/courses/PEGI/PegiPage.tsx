...
const MODULES: ProgramModule[] = [
  { numero: '01', titulo: 'Gerencia Estratégica', descripcion: 'Desarrollo de pensamiento sistémico y planificación avanzada para la sostenibilidad de empresas inmobiliarias en mercados volátiles.' },
  { numero: '02', titulo: 'Finanzas Inmobiliarias', descripcion: 'Ingeniería financiera aplicada, valoración técnica de activos, control de gestión y optimización de estructuras de costos gerenciales.' },
  { numero: '03', titulo: 'Marketing y Ventas', descripcion: 'Diseño de estrategias comerciales de alto nivel y dominio de técnicas de negociación corporativa para cierres de gran escala.' },
  { numero: '04', titulo: 'Liderazgo Gerencial', descripcion: 'Potenciación de habilidades directivas, comunicación asertiva, gestión de crisis y compromiso organizacional con visión inspiradora.' },
  { numero: '05', titulo: 'Gestión de Proyectos', descripcion: 'Metodologías técnicas para la preservación de activos, planificación de mantenimiento y optimización de recursos operativos.' },
  { numero: '06', titulo: 'Derecho Mercantil', descripcion: 'Análisis jurídico exhaustivo de la Ley de Propiedad Horizontal y cumplimiento de normativas vigentes en el entorno empresarial.' },
]
      ...
      <main className="bg-white text-slate-900 rounded-t-[3rem] sm:rounded-t-[4rem] -mt-12 relative z-10 px-4 sm:px-6 lg:px-20 py-24">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12 mb-20 bg-slate-50 p-8 lg:p-16 rounded-[3rem] border border-emerald-50 relative overflow-hidden">
            ...
            <div className="w-full lg:w-2/3 space-y-6 relative z-10">
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                Dictado en alianza estratégica con <strong>Iplaza Soluciones</strong>, el PEGI está diseñado para directivos que buscan optimizar su gestión empresarial inmobiliaria.
              </p>
            </div>
          </div>
          ...
          <div className="relative mt-16 group">
            <div ref={(el) => setRevealEstudiosa(el)} className="reveal-on-scroll absolute -bottom-50 -left-150 z-10 pointer-events-none hidden lg:block transition-all duration-1000 opacity-0 [&.active]:opacity-20">
              <img src={Estudiosa} alt="Watermark" className="h-[800px] w-auto max-w-none transform" />
            </div>
            <div ref={(el) => setRevealEstudioso(el)} className="reveal-on-scroll absolute -bottom-40 left-270 z-10 pointer-events-none hidden lg:block transition-all duration-1000 opacity-0 [&.active]:opacity-20">
            ...
            <div className="relative z-10 p-6 sm:p-12 rounded-[2rem] sm:rounded-[4rem] bg-[#022c22]/95 backdrop-blur-sm text-white text-center space-y-8 overflow-hidden border border-white/5">
              <div className="relative z-10">
                <h3 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tighter">¿Listo para liderar la transformación gerencial?</h3>
                <PreinscripcionProgramaForm programaCodigo="PEGI" ctaLabel="Confirmar" />
                <div className="mt-6">
                  <button
